...
router.get('/jobseeker', async (req, res, next) => {
 try {
  ...
  res.render('seeker/landing', {
    ...
    metaDescription: 'Create a free Youth Careers Canada profile, upload your resume once and apply to Canadian jobs in one click. Get job alerts matched to your skills — internships, graduate roles, entry-level jobs and skilled careers.',
