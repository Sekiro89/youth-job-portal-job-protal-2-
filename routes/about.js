...
const QUICK_ANSWERS = [
  { q: 'What is Youth Futures Canada?', a: 'Youth Futures Canada is a Canadian job bank for young people — students, interns, graduates, early-career candidates and skilled young professionals — at every stage of building a career in Canada. Employers and third-party consultants post jobs; job seekers search, apply online and receive matched job alerts.' },
  { q: 'Who can post jobs on Youth Futures Canada?', a: 'Any Canadian employer can post directly, and third-party consultants (recruiters, staffing agencies and HR consultants) can post on behalf of the many employers they represent from one account.' },
  ...
  { q: 'What does a job posting on Youth Futures Canada include?', a: 'Every posting carries at least one full work address (street, city, province and postal code — several addresses on one posting are allowed), the employer’s operating name shown to job seekers, salary with its pay period, education and experience levels, an industry category and an optional NOC code.' },
  { q: 'Is Youth Futures Canada free for job seekers?', a: 'Yes. Job seekers sign up free, upload a resume, apply online and receive job alerts at no cost — there are no paid tiers for candidates.' },
  { q: 'How do job alerts work?', a: 'When a new job is published, Youth Futures Canada compares it with each job seeker’s profile — category, province, city, work arrangement and experience — and emails matching candidates, on the frequency they choose.' },
  { q: 'Who does Youth Futures Canada serve?', a: 'Young people building a career in Canada, at any stage — students, interns and co-op candidates, new graduates, early-career and junior candidates, and skilled young professionals with real experience already behind them — in all 13 Canadian provinces and territories.' },
];
...
const FAQ = [
  { q: 'How much does it cost to post a job on Youth Futures Canada?',
  ...
  { q: 'Does a job posting need a full work address?',
    a: 'Yes. Every posting created on Youth Futures Canada needs at least one complete work location — street address, city, province and postal code — and a posting may list several addresses when the job is offered at more than one site. Job seekers see each address in full on the posting, Job Bank style. The employer’s operating (trade) name is shown first, with the legal company name beneath it.',
  ...
  { q: 'Is Youth Futures Canada free for job seekers?',
  ...
  { q: 'Which parts of Canada does Youth Futures Canada cover?',
  ...
  { q: 'Is Youth Futures Canada accessible?',
    a: 'Youth Futures Canada is designed with the Web Content Accessibility Guidelines (WCAG) in mind: semantic headings, keyboard navigation, visible focus states, labelled form fields and sufficient colour contrast, on every screen size. If something gets in your way, please tell us so we can fix it.',
  ...
  { q: 'How do I contact Youth Futures Canada?',
    a: 'Use the contact form to reach the Youth Futures Canada team about a job posting, billing, your account or a technical issue. We reply by email.',
...
function buildJsonLd(PUBLIC_URL) {
  ...
  const organization = {
    ...
    '@type': 'Organization',
    '@id': orgId,
    name: 'Youth Futures Canada',
    alternateName: 'Youth Futures Canada Job Bank',
    url: PUBLIC_URL,
    ...
    makesOffer: [
      offer('Job posting on Youth Futures Canada — employer', 'One job posting by an employer on Youth Futures Canada, renewed monthly until cancelled. GST is added at checkout.', EMP.cents, `${PUBLIC_URL}/employer`),
      offer('Job posting on Youth Futures Canada — third party consultant', 'One job posting by a third-party consultant on behalf of a client, renewed monthly until cancelled. GST is added at checkout.', CON.cents, `${PUBLIC_URL}/consultant`),
    ],
  };
  const website = {
    '@context': 'https://schema.org',
  ...
  const aboutPage = {
    ...
    '@id': `${url}#webpage`,
    url,
    name: 'About Youth Futures Canada — careers in Canada for young talent everywhere',
    description: 'Who Youth Futures Canada is, who it serves, what a job posting costs and how job seekers use it free.',
    inLanguage: 'en-CA',
    isPartOf: { '@id': siteId },
    about: { '@id': orgId },
    mainEntity: { '@id': orgId },
