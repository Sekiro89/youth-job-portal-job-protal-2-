...
const FAQ = [
  ...
  { q: 'Is Canada Careers accessible?',
    a: 'Canada Careers is designed with the Web Content Accessibility Guidelines (WCAG) in mind: semantic headings, keyboard navigation, visible focus states, labelled form fields and sufficient colour contrast, on every screen size. If something gets in your way, please tell us so we can fix it.',
