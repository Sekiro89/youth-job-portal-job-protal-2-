...
function layout(title, bodyHtml, cta, opts) {
  const PUBLIC_URL = (opts && opts.publicUrl) || process.env.PUBLIC_URL || 'https://jobs.khosha.tech';
...
module.exports = { send, sendTest, layout, config, configured, PUBLIC_URL: process.env.PUBLIC_URL || 'https://jobs.khosha.tech' };
