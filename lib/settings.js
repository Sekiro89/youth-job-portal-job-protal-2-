...
const DEFS = {
  ...
  site_name:               { env: 'SITE_NAME', default: 'Youth Careers Canada', group: 'branding', label: 'Site name' },
  ...
  mail_from_name:          { env: 'MAIL_FROM_NAME', default: 'Youth Careers Canada', group: 'email', label: 'Sender name' },
