...
| Payments | `/admin/payments` | Every charge (employers $14.99 + 5% GST = $15.74, consultants $9.99 + 5% GST = $10.49 CAD per posting per month), totals by month, GST collected, and a link to each printable receipt (`/billing/receipt/:id`). |
